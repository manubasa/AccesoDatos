...
using APIPlaceMyBet.Providers;
using APIPlaceMyBet.Results;
...
namespace APIPlaceMyBet.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            new UsuarioRepository().RegisterUser(new Usuario(model.Email, model.Nombre, model.Apellidos, model.Edad));
